...
# Best practices
[Source Making](https://sourcemaking.com/refactoring/refactorings) • [Refactoring Guru](https://refactoring.guru/) • [Clean Code Developer](https://clean-code-developer.de/en/) • [It's probably time to stop recommending Clean Code](https://qntm.org/clean)
# Blogs
...
## Tools
[Quick C++ Benchmark](https://quick-bench.com/) • [C++ Insights - code desugarizer](https://cppinsights.io/) • [Compiler Explorer](https://godbolt.org/)
## Type layout
...
## Libraries to build side projects with
[MPI](http://www.mpi-forum.org/) • [OpenMP](http://www.openmp.org/)
___
# C# .net
...
[Maoni0](https://maoni0.medium.com/) • [Maoni0](https://devblogs.microsoft.com/dotnet/author/maoni/) • [Fabulous adventures in coding - Eric Lippert](https://ericlippert.com/) • [Isaac Levin](https://www.isaaclevin.com/)
## .net memory
